...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView className="bg-[#FBF6EE] flex-1 pb-10">
      <ScrollView style={{marginTop: Platform.OS === 'ios'? 0 : 18}}  >
          {/* //Trash Bin Decision */}
       
          <TouchableWithoutFeedback
            onPress={() => navigation.navigate("Trash Bin Decision")}
          >
            <View className="mr-[70px] items-end mt-5 ">
          ...
          >
            <View className="mr-[200] items-end mt-[10] mb-[90px] " >
              ...
              <View className="w-[65px] h-[65px] rounded-full bg-black items-center justify-center mt-[50] mr-[50]" >
                <MaterialCommunityIcons
                  name="cart-heart"
                  size={30}
                  color="white"
